...
class Route {
  ...
  playlist(name) {
    ...
    let playlist = this.playlists[name];
    if (!(playlist instanceof Playlist))
      playlist = this.playlists[name] = new Playlist(this.session, this.playlists[name]);
    return playlist;
  }
}
...
class ArdourXML {
  ...
  getRoute(routeName) {
    ...
    if (route && !(route instanceof Route)) {
      route = this.routes[routeName] = new Route(this, route);
    }
